...
app.get('/login', (req, res) => {
  // Make sure you have: /views/login.html
...
app.post('/login', (req, res) => {
  ...
  // Simple error message; you can style this in the HTML instead
  return res
    .status(401)
    .send("Invalid login. <a href='/login'>Try again</a>");
});

// Serve a simple dashboard page after successful login
app.get('/dashboard', (req, res) => {
  // Make sure you have: /views/dashboard.html
